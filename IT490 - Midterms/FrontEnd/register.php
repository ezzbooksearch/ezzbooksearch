...
<div class="container" class="container-fluid">
  <form id="signup" class="form-horizontal" action ="register.php" method="post" enctype="multipart/form-data" autocomplete="on">
  ...
  <?php include('errors.php'); ?>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
      <font color=red>*</font><input type="password" name="password" class="form-control" id="password" placeholder="Enter password">
      </div>
    </div>
